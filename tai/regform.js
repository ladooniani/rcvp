...
var c1 = '&nbsp; Terbinari operating program represents interactive training and conversation model, natural language processing semantic analysis/matching logic algorithms and controller operating methods.<br><br><img src="assets/terbinari-application.jpg" class="images_sq" onclick="resImg(1)" id="img1" /><br> &nbsp;';
...
var contactTxt = '<br>Hello, dear guest!<br><br>Thank you for visit<br><br>Laboratory is open and responsive for collaborative and productive conversation<br><br>Please, be free to contact';
...
var supportTxt = '<br>Laboratory founded as non profit scientific and engineering organization.<br><br>Practical experience and development process in research is amid to create and investigate synthetic entity architecture and behavior.<br><br>The philosophy of vision in research, inspired and motivated by concept to invent and build experimental and assistive educational, therapeutic, social and humanitarian interactive and robotic technologies.<br><br> Research and development includes a number of areas, such as computational logic, cognitive science, mechanical design/engineering and industrial/artistic design <br><br>Your donation will help expand independent research workflow, improve laboratory environment and speed up conceptual strategy process, which leads to more involved research in frames of related technology, forming educational platform for creative/intellectual collaboration and search for other references.<br><br>'+donationBtn+'<br>At this stage we are preparing for presentation event with research overview and Terbinari CBM robot demonstration, planned in May of 2021, exact date/location will be announced later.<br><br>To get updates from research workflow, please follow us in social networks and subscribe to <a target="_blank" class="tlink" style="font-size:15px;color:red" href="https://www.youtube.com/channel/UC0Z161RgR5KpwPLvEDzkk9Q?view_as=subscriber">YouTube</a> channel';
var logo_name = 'T A I';
