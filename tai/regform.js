...
var linkReadme = anima + '&nbsp;<a target="_blank" class="tlink" href="https://github.com/ladooniani/terbinari"><u>Read more about Terbinari CBM project</u></a>';
var videoCov1 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/vxVBtnA5of8?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>';
var videoCov2 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/xZZ-RWoMQD4?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>';
var videoCov3 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/tSrj2ZdIo80?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>';
var videoCov4 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/f801_bk9htc?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>';
var videoCov5 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/m1xcjhqGcHw?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>';
var videoCov6 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/oKQQEKq7pdc?rel=0 " title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>';
var videoCov7 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/H2O3pTNejW0?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>';
var videoCov8 = '<br><br><div class="embed-responsive embed-responsive-16by9"> <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/UsEniQiI9Xk?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div><br>'; 
var randVal = 0;
var randomVid = "";
...
function loadTxt() {
	...
	videotxt.innerHTML = converTitSize +  overview_descript + randomVid;
...
function randomVideo(){
	randVal = getRandomInt(8);
	if (randVal == 0){
		randomVid = videoCov1 + linkReadme;
	} else if (randVal == 1) {
		randomVid = videoCov2 + linkReadme;
	}else if (randVal == 2) {
		randomVid = videoCov3 + linkReadme;
	}else if (randVal == 3) {
		randomVid = videoCov4 + linkReadme;
	}else if (randVal == 4) {
		randomVid = videoCov5 + linkReadme;
	}else if (randVal == 5) {
		randomVid = videoCov6 + linkReadme;
	}else if (randVal == 6) {
		randomVid = videoCov7 + linkReadme;
	}else if (randVal == 7) {
		randomVid = videoCov8 + linkReadme;
	}
}
...
function fnc(searchStr){
	var subStr = strArr.find((a) => a.includes(searchStr));
	console.log(searchStr + " --- " + subStr);
}
